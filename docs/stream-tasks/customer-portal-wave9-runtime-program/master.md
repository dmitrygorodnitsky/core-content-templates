...
| --- | --- | --- | --- | --- |
| contract-baseline | `app-templates/customer-portal/ARCHITECTURE.md`, package docs | Codex | todo | Contract only; no runtime edits. |
...
| shared-config-router | `runtime/src/config.js`, `router.js`, shell/nav/theme/profile code | Codex | todo | Shared route/profile contract; serialize edits here. |
