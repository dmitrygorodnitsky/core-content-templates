...
Current target: S2 Care Executable Transfer (`done`)
...
- 2026-07-10: S2 closed after three independent validation cycles. Eight Care
  ...
  regressions are validated. See `evidence/S2.md`.
