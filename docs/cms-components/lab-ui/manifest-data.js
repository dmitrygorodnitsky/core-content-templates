window.LAB_UI_MANIFEST = {
  ...
  "blocks": [
    ...
    },
    {
      ...
      "description": "ServiceWand plan comparison matrix. 2–4 plan columns driven by column_count, four feature groups, twelve feature rows. Desktop renders a sticky-header table; the mobile breakpoint collapses into a per-plan accordion using the same parameter values.",
      "canonical": false,
      "theme": "light",
      "sourceLabel": "https://attio.com/pricing/",
      "preview": {
    ...
    },
    {
      ...
      "title": "Pricing · plans (flexible 2–5)",
      "description": "ServiceWand pricing plan grid that renders any 2–5 plans via a per-slot visibility ENUM. Monthly/Annual toggle exposes an inline Save chip on the Annual option and broadcasts a document-level CustomEvent so comparison and credit blocks can sync billing period without coupling.",
      "canonical": false,
      "theme": "light",
      "sourceLabel": "https://attio.com/pricing/",
      "preview": {
