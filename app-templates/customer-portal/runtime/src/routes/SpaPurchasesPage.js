...
export function SpaPurchases() {
  ...
  if (!live && state.spaPurchMore === "loading") { card.appendChild(skeletonRow()); card.appendChild(skeletonRow()); }
  ...
  page.appendChild(h("div", { "class": "card__footnote", style: "border-top:0;padding:12px 4px 0" }, live
    ? "Amounts and raw Order states come from Core exactly as returned. Line items, receipts and payment history are not returned by this API."
    : "Amounts and statuses come from our records exactly as written \u2014 receipts and payment history aren\u2019t part of this portal yet."));
  return page;
}
