...
import { GateGlyph, LandingReturnButton, SupportContactButton } from "./Destinations.js";
...
function supportOrSignOut() {
  ...
  return gateActions([
    ...
    ActionButton(support
      ? { variant: "btn--ghost", label: "Sign out", action: "auth.signOut", block: true, visualId: "account-signout" }
      : { variant: "btn--primary", label: "Sign out", action: "auth.signOut", block: true, lg: true, visualId: "account-signout" })
  ]);
}
