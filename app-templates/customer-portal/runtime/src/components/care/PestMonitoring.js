// customer-portal/runtime/src/components/care/PestMonitoring.js — Wave 7 (Pest Control): station monitoring between visits. No business logic.
...
export function PestMonitoring(m, ui) {
  /* summary strip */
  ...
  var rStatus = ui.retreatPending || (ui.retreatRequest && ui.retreatRequest.status === "submitting") ? "requesting"
    : ui.retreatRequest && ui.retreatRequest.status === "submitted" ? "used"
    : m.guarantee.status || "available";
