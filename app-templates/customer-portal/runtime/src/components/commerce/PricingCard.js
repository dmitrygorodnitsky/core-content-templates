...
export function PricingCard(props) {
  ...
  var body = h("div", props.featured ? { style: "position:relative;display:flex;flex-direction:column;flex:1" } : null, [
    ...
    props.current
      ...
      : h("div", { style: "margin-top:18px" }, ActionButton({ variant: props.featured ? "btn--onaccent" : "btn--ghost", label: props.ctaLabel || "Activate plan", action: props.action || "booking.open", id: props.actionId, block: true, lg: true, visualId: "activate-plan" }))
  ]);
