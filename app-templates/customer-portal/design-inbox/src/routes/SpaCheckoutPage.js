...
import { cmdPhase, currentContact, spaCapability, spaCartLines, spaRetailOpen, state } from "../state.js";
...
function quoteSource() {
  ...
  if (state.spaCheckoutSource === "plan") return F.spaCommerce.checkout.planQuotes[state.spaPlanOffer || "off-pkg-4c21"] || F.spaCommerce.checkout.planQuote;
