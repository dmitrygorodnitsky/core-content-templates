...
export function SpaAppointmentDetail() {
  ...
  var page = h("section", { "class": "page page--narrow", "data-route": "appointment.detail", "data-state": state.view, "data-visual-id": "appointment-detail", "data-module": "appointment-detail", "data-capability": spaCapability(), "data-appointment-ref": a ? a.ref : undefined, "data-screen-label": "Appointment detail" });
  ...
  var conflict = state.view === "conflict";
