...
export function SpaProfile() {
  var page = h("section", { "class": "page page--narrow", "data-route": "profile", "data-state": state.view, "data-visual-id": "spa-profile", "data-module": "spa-profile", "data-capability": spaCapability(), "data-screen-label": "Profile (Calm Harbor)" });
  page.appendChild(h("div", { "class": "detail-back" }, h("span", { "class": "link-action", "data-action": "account.open" }, "\u2039 Account")));
  page.appendChild(PageHeader({ title: "Profile", sub: "Your contact details and preferences \u2014 nothing else is stored here." }));
  ...
  var canEdit = F.spaProfileSrv.allowedActions.indexOf("edit") !== -1;

  /* ---- contact details ---- */
  var panel = h("div", { "class": "list-panel", "data-module": "spa-profile-contact", "data-visual-id": "spa-profile-contact", "data-state": panelState, "data-profile-version": F.spaProfileSrv.version }, [
  ...
  if (!editing) {
    ...
    var ro = h("div", { "class": "appt-details" }, [
      h("div", { "class": "appt-details__row" }, [h("div", { "class": "appt-details__label" }, "Phone"), h("div", { "class": "appt-details__val" }, h("b", { "data-bind": "profile.phone" }, confirmed.phone))]),
      h("div", { "class": "appt-details__row" }, [h("div", { "class": "appt-details__label" }, "Email"), h("div", { "class": "appt-details__val" }, h("b", { "data-bind": "profile.email" }, confirmed.email))])
    ]);
    ...
    [["Phone", "phone", "tel"], ["Email", "email", "email"]].forEach(function (fd) {
  ...
  page.appendChild(h("div", { "class": "catalog-note" }, "This page holds only your contact details and the preferences above \u2014 exactly as the studio\u2019s system returns them."));
  return page;
}
