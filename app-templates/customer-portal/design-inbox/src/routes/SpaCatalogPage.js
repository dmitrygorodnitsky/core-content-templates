...
import { spaBookingOpen, spaCapability, spaPlanSellOpen, state } from "../state.js";
...
export function SpaCatalog() {
  ...
  var page = h("section", { "class": "page", "data-route": state.route, "data-state": state.view, "data-visual-id": "spa-catalog", "data-module": "spa-catalog", "data-screen-label": "Services & prices (" + tab + ")" });
  ...
  if (tab === "services") {
    ...
    F.spa.pim.services.forEach(function (s) {
    ...
    F.spa.pim.services.forEach(function (s, i) {
      var pal = F.PAL[i % 4];
    ...
    if (sellOpen) {
      ...
      F.spaCommerce.planOffers.forEach(function (o) { ogrid.appendChild(offerCard(o)); });
      ...
      F.spa.pim.memberships.forEach(function (m) {
