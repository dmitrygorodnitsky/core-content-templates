// customer-portal-design/src/components/care/shared.js — Wave 7 shared pieces. Presentation runtime, no business logic.
...
export function DocRow(d) {
  return h("div", { "class": "log-row", "data-module": "document-row", "data-visual-id": "document-row", "data-document-id": d.id }, [
    ...
    h("div", { "class": "link-action", "data-action": "care.download", "data-id": d.id }, "Download")
  ]);
}
