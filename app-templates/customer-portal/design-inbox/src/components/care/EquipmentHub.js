// customer-portal-design/src/components/care/EquipmentHub.js — Wave 7 (HVAC): equipment passport + diagnostics. No business logic.
...
export function EquipmentHub(m) {
  var u = m.units.find(function (x) { return x.id === state.careUnit; }) || m.units[0];
