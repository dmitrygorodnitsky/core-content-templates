...
`customer-portal-design/media/` — the page renders them; the striped `no-data`
...
| | |
| --- | --- |
| File | `customer-portal-design/media/spa-massage-1448.webp` **(delivered)** |
...
| | |
| --- | --- |
| File | `customer-portal-design/media/spa-room-1600.webp` **(delivered)** |
