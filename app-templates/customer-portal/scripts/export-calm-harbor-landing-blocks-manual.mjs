...
(function () {
  ...
  function product(row) { var value = row && row.product || {}; var entity = value.product || value; if (entity === value) return entity; return Object.assign({}, entity, { attributes: value.attributes || entity.attributes || {}, type: value.type || entity.type || null }); }
