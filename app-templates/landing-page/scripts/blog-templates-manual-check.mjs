...
assert.match(post.javascript, /renderTags\(root, post\)/);
assert.match(post.javascript, /relevanceOf\(post, currentPost\)/);
assert.match(post.html, /data-blog-tags/);
assert.match(index.javascript, /function categoryNames\(post\)/);
assert.match(index.javascript, /taxonomyOf\(post\.categories, locale\)/);
assert.match(index.javascript, /taxonomyOf\(post\.tags, locale\)/);
assert.match(index.javascript, /blog-post\/" \+ kind \+ "\.json"/);
