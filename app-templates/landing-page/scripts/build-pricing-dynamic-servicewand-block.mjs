...
const outDir = join(labRoot, "blocks", "14-pricing", "pricing.dynamic-servicewand");
...
const params = [
  ...
  prefixedParam("matrix", "hint_style", {
    default: "tooltip",
    description: "Controls whether attribute Placeholder text is exposed as a tooltip trigger. Descriptions remain rendered as normal row descriptions.",
  }),
  prefixedParam("matrix", "tip_label", {
    description: "Accessible label prefix for matrix row tooltip triggers.",
  }),
...
const blockJson = {
  ...
  theme: "light",
  source: {
    primary: "app-templates/landing-page/blocks/14-pricing/_combined-preview.html",
    ...
    localScripts: ["blocks/14-pricing/_shared/pricing-runtime.js"],
  },
  depends_on: {
...
for (const size of ["1440", "390"]) {
  const from = join(labRoot, "blocks", "14-pricing", "pricing.plans-flex", `preview-${size}.png`);
